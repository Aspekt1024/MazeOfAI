...
public class Facility : Building {
    ...
    {
        // TODO create spawn class and use that instead of creating the functionality here
        ...
        unit.GetComponent<Unit>().MoveUnitToPoint(transform.position, transform.position + Vector3.right * 3.5f);  // TODO building waypoints
    }
    ...
    public override List<string> GetStatsList() // TODO Stats = Info - this could be named better
    {
